...
import com.goruna.spring.shop.service.AdminSearchService;
...
public class AdminSearchController {
    ...
    public ResponseEntity<ApiResponse<List<AdminSearchResponseDTO>>> getAdminAllShop(){
        List<AdminSearchResponseDTO> allShops = adminSearchService.getAdminAllSearch();
