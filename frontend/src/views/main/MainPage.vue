        ...
        <ul class="flex sale_list">
          <li class="sale_product">
            <div class="product_title_box">
              <div class="product_name">초코집</div>
              <div class="category_name">베이커리</div>
            </div>
            <div>
              <img class="sale_shop_img" src="https://goruna.s3.us-west-1.amazonaws.com/935b1a55-b212-4202-bf4e-2953749751be_mainBanner.png" alt="매장 이미지">
            </div>
            <div class="price_box">
              <div class="sale_price_title">할인가</div>
              <div class="flex price_text_box">
                <div class="original_price_box">
                  <div class="original_price">7000원</div>
                ...
                <div class="sale_price">2000원</div>
              </div>
            </div>
          </li>
          <li class="sale_product">
