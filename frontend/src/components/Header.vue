      ...
      <div class="flex" id="icon_boxes">
        ...
        <div>
          <svg width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M26.2933 28.7565L26.2933 28.7565C23.8313 32.2016 19.7703 34 13.9964 34C8.22094 34 4.16306 32.2009 1.70771 28.7548C1.24738 28.1088 1 27.3353 1 26.542V24.9318C1 23.3101 2.31458 21.9956 3.93623 21.9956H24.0678C25.6896 21.9956 27.0041 23.3101 27.0041 24.9318V26.5393C27.0041 27.3345 26.7556 28.1096 26.2933 28.7565ZM13.9964 1C18.2774 1 21.7479 4.4705 21.7479 8.75157C21.7479 13.0326 18.2774 16.5032 13.9964 16.5032C9.71523 16.5032 6.24473 13.0326 6.24473 8.75157C6.24473 4.47051 9.71522 1 13.9964 1Z" stroke="white" stroke-width="2"/>
          </svg>
        </div>
        <div>
